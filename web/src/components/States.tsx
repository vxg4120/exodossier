...
/** Render children only once data resolves; otherwise the matching state. Every fetch funnels
    through this so loading/error/empty are uniform across the catalog. */
